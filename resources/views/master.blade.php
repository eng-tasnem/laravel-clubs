					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<h1>أحدث صيحات الموضة والتسوق</h1>
								<div class="hero-btns">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-center">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle">تواصل بأقل الأسعار على باب المنزل</p>
								<h1>1مأكولات طبيعية00</h1>
								<div class="hero-btns">
									<a href="shop.html" class="boxed-btn">سجل معنا</a>
									<a href="contact.html" class="bordered-btn">تواصل معنا </a>
								</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-right">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle">عروض نوعية على جميع المنتجات!</p>
								<h1>احصل على حسومات نوعة</h1>
								<div class="hero-btns">
									<a href="shop.html" class="boxed-btn">سجل معنا</a>
									<a href="contact.html" class="bordered-btn">تواصل معنا </a>
								</div>
